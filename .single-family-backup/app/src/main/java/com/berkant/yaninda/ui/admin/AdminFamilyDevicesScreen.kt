...
fun AdminFamilyDevicesScreen(
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(
                text =
                    "Aileye bağlı telefonları buradan görebilirsin.",
                style =
                    MaterialTheme.typography
                        .bodyLarge,
                color =
                ...
                YanindaCard(
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            Text(
                                text =
                                    "Yeni bir telefon bağlamak için eşleştirme oluşturabilirsin.",
                                style =
                                    MaterialTheme.typography
                                        .bodyMedium,
                                color =
    ...
    YanindaCard(
        ...
        Column(
            ...
            Text(
                text =
                    device.lastSuccessfulSyncAt
                        ...
                        ?: "Son başarılı bağlantı bilgisi yok.",
                style =
                    MaterialTheme.typography
                        .bodyMedium,
                color =
            ...
            if (device.appVersion.isNotBlank()) {
                Text(
                    text =
                        "Uygulama sürümü: ${device.appVersion}",
                    style =
                        MaterialTheme.typography
                            .bodySmall,
                    color =
