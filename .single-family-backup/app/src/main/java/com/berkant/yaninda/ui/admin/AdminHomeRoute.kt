        ...
        item {
            YanindaCard(
                ...
                Column(
                    ...
                    Text(
                        text =
                            "Konum ve güvenlik özelliği henüz bu sürümde etkin değil.",
                        style =
...
private fun AdminHomeContent(
    ...
    val familyFactory =
        remember(application) {
            FamilyAccessViewModel.Factory(
                authRepository =
                    application.familyAuthRepository,
                familyRepository =
                    application.familyRepository,
                pairingService =
                    application.devicePairingService,
                pushRegistrationRepository =
                    application.familyPushRegistrationRepository
            )
        }
    ...
    val familyState by
    familyViewModel.state.collectAsStateWithLifecycle()

    val familyId =
        familyState.memberships
            .firstOrNull()
            ?.familyId
        ...
        remember(
            ...
            familyId
                ?.let(
                    ...
                    observeCurrentSchedule
                )
                ?: flowOf(null)
        }

    val schedule by
    scheduleFlow.collectAsStateWithLifecycle(
        initialValue = null
    )
    ...
    rememberSaveable {
        mutableStateOf(
            AdminSettingsPage.LIST
        )
    }

    var unavailableSetting by
    rememberSaveable {
                    ...
                    when (settingsPage) {
                        ...
                        AdminSettingsPage.LIST -> {
                            AdminSettingsScreen(
                                ...
                                onUnavailableSetting = {
                                    unavailableSetting = it
                                },
                            )
                        }

                        AdminSettingsPage.FAMILY -> {
                            AdminFamilyConnectionScreen(
                                onBack = {
                                    settingsPage =
                                        AdminSettingsPage
                                            .LIST
                        ...
                        AdminSettingsPage.FAMILY_CONTACTS -> {
                            AdminFamilyContactsRoute(
                                familyId = familyId,
                                onBack = {
                                    settingsPage =
                                        AdminSettingsPage
                        ...
                        AdminSettingsPage.FAMILY_DEVICES -> {
                            AdminFamilyDevicesScreen(
                                devices =
                                    familyState.devices,
                                onBack = {
                                    settingsPage =
                        ...
                        AdminSettingsPage.FAMILY_PAIRING -> {
                            AdminFamilyPairingScreen(
                                invitation =
                                    familyState.invitation,
                                message =
                                    familyState.message,
                                isWorking =
                                    familyState.isWorking,
                                onBack = {
                                    familyViewModel
                                        .dismissInvitation()
                        ...
                        AdminSettingsPage.FAMILY_ACCOUNT -> {
                            AdminFamilyAccountScreen(
                                state = familyState,
                                onBack = {
                                    familyViewModel
                                        .dismissMessage()
                                ...
                                onSignOut = {
                                    /*
                                     * Hesap ekranında kalıyoruz.
                                     *
                                     * Auth state SignedOut olduğunda
                                     * aynı ekran otomatik olarak
                                     * giriş formuna dönüşecek.
                                     */
                                    familyViewModel
                                        .signOut()
...
@Composable
private fun AdminFamilyConnectionScreen(
    onBack: () -> Unit,
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(
                text =
                    "Aile kişilerini, bağlı telefonları ve hesap bilgilerini buradan yönetebilirsin.",
                style =
                    MaterialTheme.typography
                        .bodyLarge,
                color =
        ...
        item {
            AdminSettingsRow(
                ...
                title = "Aile Kişileri",
                subtitle =
                    "AİLEYİ ARA düğmesinde kullanılacak kişiler",
                onClick =
                    onFamilyContacts,
            )
        }
        ...
        item {
            AdminSettingsRow(
                ...
                title = "Cihazlar",
                subtitle =
                    "Aileye bağlı telefonları görüntüle",
                onClick = onDevices,
            )
        }
        ...
        item {
            AdminSettingsRow(
                ...
                title = "Hesap",
                subtitle =
                    "Aile hesabı ve oturum bilgileri",
                onClick = onAccount,
            )
        }
    }
        ...
        item {
            YanindaCard(
                ...
                Column(
                    ...
                    Text(
                        text =
                            "Aile durum bildirimleri Android'in bildirim sesi kanalını kullanır.",
                        style =
                            MaterialTheme.typography
                                .bodyMedium,
                        color =
