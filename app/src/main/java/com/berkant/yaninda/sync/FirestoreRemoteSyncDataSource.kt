...
class FirestoreRemoteSyncDataSource(
    ...
    override val readiness:
            Flow<RemoteSyncReadiness> =
        combine(
    ...
    override suspend fun deliver(
        ...
        if (user == null) {
            ...
            Log.w(
                TAG,
                "Deliver blocked because Firebase user is null."
            )
        ...
        if (pairing == null) {
            ...
            Log.w(
                TAG,
                "Deliver blocked because pairing is null."
            )
                        ...
                        if (
                            ...
                            transaction.set(
                                ...
                                mapOf(
                                    ...
                                    SCHEDULED_LOCAL_TIME to
                                            OCCURRENCE_TIME_FORMAT
                                                .format(
                                                    occurrence
                                                        .scheduledAt
                                                        .atZone(
                            ...
                            Log.d(
                                TAG,
                                "Occurrence document not rewritten for this event."
                            )
                        }
    ...
    private fun scopedRemoteId(
        ...
        val remoteId =
            "$deviceId$REMOTE_ID_SEPARATOR$localId"
    ...
    private companion object {
        ...
        const val OCCURRENCES =
            "occurrences"

        const val SYNC_EVENTS =
            "syncEvents"
        ...
        const val MEDICATION_DISPLAY_NAME =
            "medicationDisplayName"

        const val SCHEDULED_AT =
            "scheduledAt"

        const val SCHEDULED_LOCAL_TIME =
            "scheduledLocalTime"

        const val SCHEDULED_ZONE_ID =
            "scheduledZoneId"

        const val STATUS =
            "status"

        const val ACKNOWLEDGED_AT =
            "acknowledgedAt"

        const val ACKNOWLEDGEMENT_ACTOR =
            "acknowledgementActor"

        const val LAST_ALERTED_AT =
            "lastAlertedAt"

        const val UPDATED_AT =
            "updatedAt"

        const val SOURCE_DEVICE_ID =
            "sourceDeviceId"

        const val SOURCE_EVENT_ID =
            "sourceEventId"
        ...
        const val AGGREGATE_ID =
            "aggregateId"

        const val AGGREGATE_VERSION =
            "aggregateVersion"

        const val PAYLOAD_VERSION =
            "payloadVersion"

        const val CREATED_AT =
            "createdAt"

        const val DELIVERED_AT =
            "deliveredAt"

        const val REMOTE_ID_SEPARATOR =
            "--"

        const val MAX_REMOTE_ID_LENGTH =
            256

        val OCCURRENCE_TIME_FORMAT:
                DateTimeFormatter =
            DateTimeFormatter
                .ofPattern(
                    "HH:mm"
